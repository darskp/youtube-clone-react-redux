...
import { SiLivechat,SiYoutubemusic,SiYoutubestudio } from 'react-icons/si';
import { GiLargeDress } from 'react-icons/gi';
import { AiFillYoutube } from 'react-icons/ai';
import { TbBrandYoutube,TbBrandYoutubeKids } from 'react-icons/tb';
import { FiSettings } from 'react-icons/fi';
import { FaHistory } from 'react-icons/fa';
import { FiHelpCircle } from 'react-icons/fi';
import {HiFire} from 'react-icons/hi2';
import {HiOutlineShoppingBag} from 'react-icons/hi'
import {MdOutlineMusicNote,MdLocalMovies,MdFeedback } from 'react-icons/md'
export const sideListItems = [
  ...
  { id: 4, text: 'Library', icon: <BiLibrary size={24} /> },
  { id: 5, subdivision: true, text: 'Explore' },
  { id: 6, text: 'Trending', icon: <HiFire size={24} /> },
  { id:7, text: 'Shopping', icon: <HiOutlineShoppingBag size={24} /> },
  { id:8, text: 'Music', icon: <MdOutlineMusicNote size={24} /> },
  { id: 9, text: 'Movies & Shows', icon: <MdLocalMovies size={24} /> },
  { id: 10, text: 'Gaming', icon: <SiFacebookgaming size={24} /> },
  { id: 11, text: 'Live', icon: <SiLivechat size={24} /> },
  { id: 12, text: 'Fashion & Beauty', icon: <GiLargeDress size={24} /> },
  { id: 13, subdivision: true, text: 'More from Youtube' },
  {
    id: 14,
  ...
  { id: 18, divider: true },
  { id: 19, text: 'Settings', icon: <FiSettings size={24} /> },
  { id: 20, text: 'Report History', icon: <FaHistory size={24} /> },
  { id: 21, text: 'Help', icon: <FiHelpCircle size={24} /> },
  { id: 22, text: 'Send Feedback', icon: <MdFeedback size={24} /> },
];
