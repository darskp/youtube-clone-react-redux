...
const SigninBtn = () => {
    return (<>
        <Box sx={flexAlignCenter}>
            <IconButton sx={{ mr: 1, color: "#333" }} >
                <MoreVertIcon />
            </IconButton>
            <Button sx={{
                display: "flex", alignItems: "center", border: "1px solid lightgray", borderRadius: 5, px: 1.5, py: 0.2
}}>
                <Typography sx={{ mr: 1, mt: 0.5,zIndex:1 }}><FaUserCircle size={20} color={theme.palette.info.main} /></Typography>
